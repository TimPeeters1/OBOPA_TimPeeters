...
Block& Block::operator=(Block&& other) noexcept{
	//https://en.wikipedia.org/wiki/Move_assignment_operator (voor reference :))
	...
	if (this != &other) {
		...
		other.data = nullptr; //Reset van data van andere pointer
		other.size = 0;
		other.name = "(nodata: has been moved)";
	}
	std::cout << "!!!!! Moved and Assigned: " << this->name << "' @" << this << std::endl;
